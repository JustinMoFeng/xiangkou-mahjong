...
- 使用 144 张牌：万、筒、条、东南西北中发白、春夏秋冬梅兰竹菊。
- 胡牌检测支持标准型（4 组面子 + 1 对将）、七对子、国士无双。
- 垃圾胡不是胡牌限制，而是最低倍率：任何合法胡牌都可以胡，最低 1 倍。
- 额外倍率：自摸、门清、碰碰胡、混一色、清一色、杠、字牌刻子、花牌、杠上开花、抢杠胡。
- 计分采用“加法底分合计 × 翻倍项”，最高 24 倍；清一色和杠上开花会触发翻倍。
- 春夏秋冬梅兰竹菊会在开局或摸牌时自动亮出并补摸，花牌不进入手牌，每张 +1 倍。
- 支持吃、碰、明杠、暗杠、补杠、补花；补杠可被抢杠胡，杠后补摸胡牌按杠上开花结算。
- 朋友房间使用房主权威同步，空座会由机器人补位。
...
牌面使用 `tilekit` 生成的本地 SVG 图片，文件位于 `public/tiles/`，包含 34 种基础牌、8 张花牌和背面牌。万、筒、条、风牌、箭牌、花牌都会以本地牌面显示，不依赖外链图片。
